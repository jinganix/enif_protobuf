...
ep_test_load_m1_cache(ErlNifEnv *env)
{
    ...
    cache_list[1] = mk_msg_def(env, "m2", list_from_terms(env,
        (ERL_NIF_TERM[]) { mk_field(env, st, "int32", 1, 1, st->atom_int32, st->atom_optional) }, 1));
    cache_list[2] = mk_msg_def(env, "m3", list_from_terms(env,
        (ERL_NIF_TERM[]) {
            mk_field(env, st, "int32", 0, 1, st->atom_int32, st->atom_optional),
            mk_field(env, st, "int64", 1, 2, st->atom_int64, st->atom_optional)
        }, 2));
    cache_list[3] = mk_enum_def(env, "e", list_from_terms(env,
        (ERL_NIF_TERM[]) {
            enif_make_tuple2(env, enif_make_atom(env, "v1"), enif_make_int(env, 100)),
            enif_make_tuple2(env, enif_make_atom(env, "v2"), enif_make_int(env, -2)),
            enif_make_tuple2(env, enif_make_atom(env, "v3"), enif_make_int(env, -2)),
            enif_make_tuple3(env, st->atom_option,
                make_atom(env, "allow_alias"), st->atom_true)
        }, 4));
...
{
    switch (idx) {
    case 0: return enif_make_int(env, 1);
    case 1: return enif_make_int64(env, -2);
    case 2: return enif_make_uint(env, 3);
    case 3: return enif_make_uint64(env, 4);
    case 4: return enif_make_int(env, -5);
    case 5: return enif_make_int64(env, 6);
    case 6: return enif_make_int(env, 7);
    case 7: return enif_make_int64(env, 8);
    case 8: return enif_make_int(env, 9);
    case 9: return enif_make_int64(env, 10);
    case 10: return state->atom_true;
    case 11: return enif_make_double(env, 1.5);
    case 12: return enif_make_double(env, 2.5);
    case 13: return enif_make_string(env, "hello", ERL_NIF_LATIN1);
    case 14: return enif_make_string(env, "bytes", ERL_NIF_LATIN1);
    case 15: return enif_make_atom(env, "v1");
    case 16: return enif_make_tuple2(env, enif_make_atom(env, "m2"), enif_make_int(env, 7));
    case 17: return enif_make_list_cell(env,
            enif_make_tuple2(env, enif_make_string(env, "k1", ERL_NIF_LATIN1), enif_make_int(env, 42)),
            enif_make_list(env, 0));
    case 18: return enif_make_int(env, 99);
    case 19: return state->atom_undefined;
    case 20: return enif_make_list(env, 3, enif_make_int(env, 1), enif_make_int(env, 2), enif_make_int(env, 3));
    case 21: return enif_make_tuple2(env, enif_make_atom(env, "int32"), enif_make_int(env, 55));
    default: return state->atom_undefined;
    }
}
