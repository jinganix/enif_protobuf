...
test_utf8_edge_codepoints(void)
{
    ...
    TEST_ASSERT(ep_test_roundtrip(env,
        enif_make_tuple2(env, enif_make_atom(env, "t_u"),
            enif_make_list(env, 1, enif_make_int(env, 0xFFFF))), "t_u") == RET_OK);
    TEST_ASSERT(ep_test_roundtrip(env,
        enif_make_tuple2(env, enif_make_atom(env, "t_u"),
            enif_make_list(env, 1, enif_make_int(env, 0xFFFE))), "t_u") == RET_OK);
    TEST_ASSERT(ep_test_roundtrip(env,
        enif_make_tuple2(env, enif_make_atom(env, "t_u"),
            enif_make_list(env, 1, enif_make_int(env, 0x10000))), "t_u") == RET_OK);
